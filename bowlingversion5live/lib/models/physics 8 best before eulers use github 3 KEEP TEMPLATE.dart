...
SimResult runSimulationV2(BowlerInputs inp, PatternData pat, BallSpecs ball, OilMatrix oil) {
  ...
  while (ft < LANE_FT.toDouble() && vx > 0.3) {
    ...
    if (ft < 6.0) {
      ...
      print('uy: $uy');
      print('----------------');
      print('slipRatio: $slipRatio');
      print('slipBlendY: $slipBlendY');
      print('oilGripY: $oilGripY');
      print('tractionTargetY: $tractionTargetY');
}
